...
/*   Updated: 2025/07/18 01:57:27 by maskour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_getcwd(char *oldpwd_update, t_cmd *cmd_path, t_shell *shell_ctx);
...
int	process_all_heredocs(t_cmd **cmds, int cmd_count, char **env, t_shell *shell_ctx);
void	setup_pipes_in_child(int i, int cmd_count, int prev_pipe, int pipes[2]);
...
void	execute_pipeline(t_cmd **cmds, char **env, t_env *env_list, t_exec_ctx *exec_ctx);
...
int	apply_input_redirection(int last_in_fd, int orig_stdin, int orig_stdout);
int	apply_output_redirection(int last_out_fd, int orig_stdin, int orig_stdout);
...
void	execute_child(t_cmd **cmds,char **env, t_env *env_list, t_exec_ctx *ctx);
void	handle_parent_process(int i, int *prev_pipe, int pipes[2], int cmd_count);
